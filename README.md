...
### Implementation of abortable promise

<font color="yellow">**5-promise**</font>

This snippet provides an example of an abortable promise implementation that supports the standard contract of built-in APIs. Unfortunately, we don't have direct access to abort errors, so for full compatibility it's better to create a separate error class.
